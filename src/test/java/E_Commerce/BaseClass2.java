...
public class BaseClass2 {
	...
	public void configureAppium() throws MalformedURLException {
		...
		options.setApp("C:\\Users\\2173346\\eclipse\\eclipse workspace\\Appium\\src\\test\\java\\resources\\General-Store.apk");
	...
	public void swipeGesture(WebElement elem, String direction) {
		((JavascriptExecutor) driver).executeScript("mobile: swipeGesture", ImmutableMap.of("elementId",
				((RemoteWebElement) elem).getId(), "direction", direction, "percent", 0.75));
	}

	public void dragAndDrop(WebElement ele) {
		((JavascriptExecutor) driver).executeScript("mobile: dragGesture",
				ImmutableMap.of("elementId", ((RemoteWebElement) ele).getId(), "endX", 594, "endY", 527));
	}
